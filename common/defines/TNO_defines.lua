...
NDefines_CareerProfile.NCareerProfile.MOD_STATISTICS_GROUP = "tno_career_profile"
NDefines_CareerProfile.NCareerProfile.MOD_STATISTICS_GROUP_NAME = "TNO_CAREER_PROFILE"
...
NDefines.NMilitary.ARMY_LEADER_COST = 0
